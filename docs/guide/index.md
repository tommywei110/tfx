...
TFX is a toolkit for building and managing ML workflows in a production
...
*   The TFX standard components are built using the TFX libraries. You can use
    the TFX libraries to add this functionality to you ML process.
