...
_ai_platform_serving_args = {
    ...
    'regions': [_gcp_region],
    # TODO(humichael): To expedite getting TF2.1 out the door, AI Platform
    # dropped sklearn/xgb support in the 2.1 runtime. They plan to add back
    # support in the upcoming runtime release.
...
# Sqlite ML-metadata db path. Beam dag runner expects this to be a local path.
_metadata_path = os.path.join(os.environ['HOME'], 'tfx', 'metadata',
                              _pipeline_name, 'metadata.db')
_blessing_path = os.path.join(_iris_root, 'experimental', 'data', 'blessing')
...
def _create_pipeline(pipeline_name: Text, pipeline_root: Text, data_root: Text,
  ...
  # TODO(humichael): Use in Evaluator once it's decided how to proceed with
  # Milestone 2.
  ...
  # is no Evaluator.
  # TODO(b/157052072): Remove blessing stub once it's optional.
